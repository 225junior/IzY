				...
				<form data-parsley-validate="" action="{{route('communes.update',$commune->id)}}" method="POST" class="form-horizontal form-label-left" novalidate="">
					...
					<div class="item form-group">
						...
						<div class="col-md-6 col-sm-6 ">
							<input type="text" id="libelle" min="2" autofocus tabindex="1" required name="libelle" class="form-control" value="{{ $commune->libelle }}">
					...
					<div class="item form-group">
						...
						<div class="col-md-1 col-sm-2 ">
							<input type="checkbox" id="check" name="active" tabindex="3" class="form-control" {{ $commune->active ==1 ?  'checked' : ''}}>
						</div>
					</div>
					...
					<div class="item form-group">
						<div class="col-md-6 col-sm-6 offset-md-4">
							<a href="{{ route('communes.index')}}" class="btn btn-primary" tabindex="4" type="button"><i class="fa fa-arrow-left"></i></a>
