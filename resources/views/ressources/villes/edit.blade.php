				...
				<form data-parsley-validate="" action="{{route('villes.update',$ville->id)}}" method="POST" class="form-horizontal form-label-left" novalidate="">
					...
					<div class="item form-group">
						...
						<div class="col-md-6 col-sm-6 ">
							<input type="text" id="libelle" min="2" required name="libelle" class="form-control" value="{{ $ville->libelle }}">
					...
					<div class="item form-group">
						...
						<div class="col-md-1 col-sm-2 ">
							<input type="checkbox" id="check" name="active" class="form-control" {{ $ville->active ==1 ?  'checked' : ''}}>
						</div>
					</div>
